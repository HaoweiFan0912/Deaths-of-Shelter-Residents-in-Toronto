...
The remainder of this paper is structured as follows: @sec-data discusses the data sources used in this project and details the data cleaning process, followed by a visualization of the dataset's key distribution and statistics. @sec-result outlines the statistical methods used and presents the findings in detail. @sec-discussion addresses the limitations of the study and offers suggestions for future research.
...
ggplot(analysis_data, aes(x = as.Date(paste(year_month, "-01", sep="")), y = total_decedents)) +
  ...
  labs(title = "Number of decedents over time", 
       x = "Time", 
...
ggplot(analysis_data, aes(x = ym(year_month), y = total_decedents)) +
  ...
  labs(title = "Simple linear regression of number of decedent by time",
       x = "Time",
       y = "Number of Decedents") +
  theme(
    panel.grid.major = element_line(color = "gray80"),  
...
ggplot(filtered_data, aes(x = year, y = total_decedents)) +
  ...
  geom_text(aes(label = paste0(round(total_decedents_pct, 1), "%")), 
            vjust = -0.5, size = 2.3) +  # Add percentage labels
...
ggplot(seasonal_data, aes(x = season, y = mean_decedents, fill = season)) +
  ...
  geom_text(aes(label = paste0(round(total_decedents_pct, 1), "%")), 
            vjust = -0.5, size = 2.5) +  # Add percentage labels
  labs(title = "Average number of decedents per season", 
       x = "Season", 
